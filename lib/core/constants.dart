...
class Constants {
  ...
  static const Color colorProverbsIdiomsBg = Color(0xFFF9F5F1);
  static const Color colorProverbsIdiomsSearch = Color(0xFFBB8E62);
  static const Color colorProverbsIdiomsText = Color(0xFF4F3822);
  static const Color colorVersionText = Color(0xFFF3A5B1);
  static const Color colorDrawerButton = Color(0xFFE8EAED);
  static const Color colorPullDown1 = Color(0xFFB41830);
